...
class FutsalFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_futsal, container, false)
        val gambar = view.findViewById<ImageView>(R.id.Gambar) // deklarasi
        val harga : Button = view.findViewById(R.id.bt_harga)
        val topbooked : Button = view.findViewById(R.id.bt_TopBooked)

        gambar.setOnClickListener { //action berdasarkan deklarasi
